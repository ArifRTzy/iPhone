...
import { View } from '@react-three/drei';      // Import View if it's from drei (or customize this based on your setup)
...
function Model() {
    ...
    //rotation
    const [smallRotattion, setSmallRotation] = useState(0)
    const [largeRotattion, setLargeRotation] = useState(0)
        ...
        <div className="screen-max-width">
            ...
            <div className="flex flex-col items-center mt-5">
                <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relative">
                    ...
                    <Canvas className="w-full h-full fixed top-0 bottom-0 left-0 right-0 overflow-hidden" 
